...
import { Eye, Ruler, Stethoscope, Glasses } from "lucide-react";
...
export function ServiceCards({ services }: ServiceCardsProps) {
  ...
  // Map icons to service names (fallback to default if not matched)
  ...
  const displayed = services.slice(0, 4); // Show up to 4 services
